            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-header-left">
                        <h5 class="text-uppercase title">Tipe Transaksi Properti</h5>
                    </div>
                ...
                <div class="card-block">
                    <div class="table-responsive mt-3">
                        <table class="table table-striped table-bordered nowrap dataTable" id="propTransactionTable">
                            <thead>
                                <tr>
                                    <th class="all">#</th>
                                    <th class="all">Nama Transaksi</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
