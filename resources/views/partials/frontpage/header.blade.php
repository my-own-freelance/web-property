    ...
    <div id="header" class="{{ $routename == 'home' ? 'head-tr' : '' }} bottom">
        <div class="container container-header">
            ...
            <div class="left-side">
                <!-- Logo -->
                <div id="logo">
                    <a href="index.html"><img src="{{ asset('frontpage/images/logo-white-1.svg') }}"
                            data-sticky-logo="{{ asset('frontpage/images/logo-purple.svg') }}" alt=""></a>
                </div>
                <!-- Mobile Navigation -->
            ...
            <div class="header-user-menu user-menu add">
                <div class="header-user-name">
                    <span><img src="{{ asset('frontpage/images/testimonials/ts-1.jpg') }}" alt=""></span>Hi,
                    Mary!
                </div>
                <ul>
